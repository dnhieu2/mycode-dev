...
#Add a section to the script so it creates a file, regular birthdy.csv
#That has the heroname data omitted from the dataset
#Using pandas or the csv library
